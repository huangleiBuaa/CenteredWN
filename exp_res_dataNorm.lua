...
cmd:option('-save',"log_exp_gNoW" ,'subdirectory to save logs')
...
for epoch=1,opt.max_epoch do
  ...
  log{
    ...
    torch.save('result_NoW_'..baseString..'.dat',results)
end
...
-- Weight normalization method, get the weight matrix 
    ...
    torch.save('SModel_NoW_'..baseString..'.t7', net:clearState())
end
