...
cmd:option('-dataPath','./dataset/cifar_provider.t7','the path of data dir')
...
provider = torch.load(opt.dataPath)
...
log_name=opt.model..'_'..opt.optimization..'_lr'..opt.learningRate
